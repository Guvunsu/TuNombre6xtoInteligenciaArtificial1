...
public class GOAPPlanner
{
        ...
        string agentId)
    {
        ...
        // Si ya est� satisfecho, plan vac�o es v�lido
        ...
        for (int step = 0; step < MAX_STEPS; step++)
        {
            ...
            foreach (var action in availableActions)
            {
                ...
                float score =
                    goalHits * 100f +              // prioridad m�xima: acercarse al goal
            ...
            if (bestAction == null)
            {
                Debug.LogWarning($"[{agentId}] Planner: No encontr� acci�n aplicable en step={step}.");
                return null;
            }
