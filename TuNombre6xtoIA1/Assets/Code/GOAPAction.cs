...
public abstract class GOAPAction : MonoBehaviour
{
    ...
    [Header("Timing")]
    [Tooltip("0 = termina solo por condici�n (CheckComplete). >0 = tambi�n puede terminar por tiempo.")]
    public float duration = 0f;

    [Header("Planner")]
    [Tooltip("Si es true, el planner puede elegir esta acci�n aunque no cambie el estado (�til para Wait/Listen).")]
